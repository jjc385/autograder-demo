...
class TestCompareAutograderResults(unittest.TestCase):
    ...
    def test_compareIdentical(self):
        self.assertEqual(compare_autograder_results(self.fname1, self.fname1), 0)

    def test_compareEquivalent(self):
        self.assertEqual(compare_autograder_results(self.fname1, self.fname2), 0)

    def test_compareDifferent(self):
        sys.stdout = None  ## Redirect stdout to ignore print statements
        self.assertEqual(compare_autograder_results(self.fname1, self.fname3), 2)
